...
if __name__ == "__main__":
    ...
    parser.add_argument("--users", type=int, default=300, help="Total number of stakeholders.")
    parser.add_argument("--pools", type=int, default=100, help="Number of stake pools.")
